...
class ProductTemplate(models.Model):
    ...
    dust_mask = fields.Boolean(string="Dusk Mask")
    ...
    foom = fields.Boolean(string="Foom")
...
class ProductProduct(models.Model):
    ...
    dust_mask = fields.Boolean(string="Dusk Mask", related="product_tmpl_id.dust_mask")
    ...
    foom = fields.Boolean(string="Foom", related="product_tmpl_id.foom")
